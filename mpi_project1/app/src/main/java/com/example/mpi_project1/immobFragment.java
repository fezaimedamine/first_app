 ...
 * Use the {@link immobFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class immobFragment extends Fragment implements MainAccueil.searchInterface,product_adapter.OnItemClickListener{
    ...
    public static immobFragment newInstance(String param1, String param2) {
        immobFragment fragment = new immobFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_immob, container, false);
        recyclerView=view.findViewById(R.id.rv_immob);
        ...
        FirestoreRecyclerOptions<product_model> options =
                new FirestoreRecyclerOptions.Builder<product_model>()
                        .setQuery(FirebaseFirestore.getInstance().collection("immob"), product_model.class)
                        .build();
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        for(QueryDocumentSnapshot documentSnapshot:queryDocumentSnapshots){
                            ...
                            if (imageURLList != null && !imageURLList.isEmpty() && documentSnapshot.get("email").equals(double_check_email) && documentSnapshot.get("name").equals(Name)) {
                                ...
                                //View view = LayoutInflater.from(getContext()).inflate(R.layout.item_image,, false);
