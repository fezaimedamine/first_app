 ...
 */
public class servicesFragment extends Fragment implements MainAccueil.searchInterface,product_adapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirestoreRecyclerOptions<product_model> options =
                new FirestoreRecyclerOptions.Builder<product_model>()
                        .setQuery(FirebaseFirestore.getInstance().collection("services"), product_model.class)
                        .build();
        ...
        FloatingActionButton floatingActionButton=(FloatingActionButton)view.findViewById(R.id.floatingActionButton6);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getContext(),Mainadd.class);
                intent.putExtra("domain","services");
