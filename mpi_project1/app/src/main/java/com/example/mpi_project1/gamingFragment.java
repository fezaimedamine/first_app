 ...
 */
public class gamingFragment extends Fragment implements MainAccueil.searchInterface,product_adapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=view.findViewById(R.id.rv_gaming);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        FirestoreRecyclerOptions<product_model> options =
                new FirestoreRecyclerOptions.Builder<product_model>()
                        .setQuery(FirebaseFirestore.getInstance().collection("books"), product_model.class)
                        .build();
